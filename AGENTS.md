...
| 项 | 当前值 | 位置 |
|---|---|---|
| **插件版本** | `0.16.13`（npm latest = 0.16.13；git tag `v0.16.13`） | `package.json` `version` |
