...
function normalizeConfigPatch(input) {
	if (!isPlainObject(input)) throw new ConfigPatchError("配置补丁必须是一个 JSON 对象（例如 {\"note\":{\"tag\":\"inbox\"}}）");
	const out = {};
