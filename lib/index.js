...
function apply(ctx, rawConfig = {}) {
	...
	*/
	const promptText = () => describePrompt(eff().prompt ?? {}, tiddlywikiToolSummary()).text;
	const applyPrompt = () => {
